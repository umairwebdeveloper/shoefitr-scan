...
const ShoeSizeSelectorMeasurements = () => {
	...
	const handleScanNow = () => {
		const selectedData = {
			status: "test_measurements",
			shopid: "charles@shoefitr.io",
			userid: 1,
			modelname: "test",
		...
		router.push(`/scan/measurements/camera?${queryString}`);
	};
	...
	return (
		<div>
			...
			<h3 className="fs-3 fw-bold text-center my-3">Test Measurements</h3>
...
export default ShoeSizeSelectorMeasurements;
